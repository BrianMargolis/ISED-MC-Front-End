...
WaveSurfer.Label = {
    ...
    updateRender: function (bottom) {
        var label = this.region.annotation || '?';
        this.text.innerHTML = "";

        // Modified by Brian Margolis, 03/01/18
        // Put an empty span with class ruler in the HTML, i.e.
        // <span class="ruler"></span>
        // That's hidden with CSS.
        // Then, we can set the content of it to be the label, and check the width of it.
        // This lets us make sure not to make our tags too small.
        this.text.innerHTML = "";
        $(".ruler")[0].innerHTML = label
        // 35 is a magic number that pads for the play and delete buttons.
        var width = Math.max(this.region.element.offsetWidth, $(".ruler").width() + 35)
        console.log(width);
